...
public class terminado extends Fragment {
    ...
    private void cargarEventos() {
        btnAgregar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(modifica){
                    insertarTerminado("http://192.168.0.22/ControlProyectoBD/modificar_terminado.php");
                }else{
                    insertarTerminado("http://192.168.0.22/ControlProyectoBD/insertar_terminado.php");
                }
    ...
    private void EliminarConfirm() {
        ...
        alert.setTitle("Eliminar")
                ...
                .setPositiveButton("Eliminar", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        eliminarTerminado("http://192.168.0.22/ControlProyectoBD/eliminar_terminado.php");
    ...
    private void eliminarTerminado(String URL) {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                LimpiarTabla();
                CargarEncabezado();
                CargarDatos("http://192.168.0.22/ControlProyectoBD/consultar_terminado.php?id_Mueble="+id);
            }
    ...
    private void AlertaModificar() {
        ...
        alert.setTitle("Cotizar")
                ...
                .setPositiveButton("Modificar", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        idTerminado = Integer.parseInt(input.getText().toString());
                        BuscarTerminado("http://192.168.0.22/ControlProyectoBD/buscar_terminado.php?id_Mueble="+id+"&id_terminado="+idTerminado);
                    }
                })
                .setNegativeButton("Cancelar", new DialogInterface.OnClickListener() {
                    @Override
    ...
    private void cargarSpiner() {
        consultarMateriales("http://192.168.0.22/ControlProyectoBD/consultar_materiales.php");
