...
public class Registrar_Material extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        cargarControle(root);
        cargarEncabezado();
        CargarDatos("http://192.168.0.22/ControlProyectoBD/consultar_materiales.php");
        CargarEventos();
        return root;
    }
    ...
    private void CargarEventos() {
        Agregar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AgregarMaterial("http://192.168.0.22/ControlProyectoBD/insertar_material.php");
            }
        });
        ...
        !spinUnidad.getSelectedItem().toString().equals("Unidad...")){
            StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    CargarNuevoDato("http://192.168.0.22/ControlProyectoBD/consultar_materiales.php");
                    Limpiar();
                }
