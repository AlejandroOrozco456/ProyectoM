...
asignar_valores();
Ejecutar_servicio("http://192.168.0.22/controlProyectoBD/insertarCompra.php");
            }
        });
        if(SpinPies.isSelected()){
            precio();
        }
    }
...
private void asignar_valores(){
    ...
    public void precio() {
        if(SpinPies.isSelected()){
            ...
            for (int i = 0; i < comprar.size(); i++) {
                if (Double.parseDouble((String) SpinPies.getSelectedItem())==4) {
                    if(comprar.get(i).getLargo() == 4){
                        preciocinco = comprar.get(i).getPrecio();
                        txtprecio.setText(preciocinco+"");
            ...
            for (int i = 0; i < comprar.size(); i++) {
                if (Double.parseDouble((String) SpinPies.getSelectedItem())==5) {
                    if(comprar.get(i).getLargo() == 5){
                        preciocinco = comprar.get(i).getPrecio();
                        txtprecio.setText(preciocinco+"");
                        txtprecio.setEnabled(false);
            ...
            for (int i = 0; i < comprar.size(); i++) {
                if (Double.parseDouble((String) SpinPies.getSelectedItem())==6) {
                    if(comprar.get(i).getLargo() == 6){
                        preciocinco = comprar.get(i).getPrecio();
                        txtprecio.setText(preciocinco+"");
                        txtprecio.setEnabled(false);
            ...
            for (int i = 0; i < comprar.size(); i++) {
                if (Double.parseDouble((String) SpinPies.getSelectedItem())==7) {
                    if(comprar.get(i).getLargo() == 7){
                        preciocinco = comprar.get(i).getPrecio();
                        txtprecio.setText(preciocinco+"");
                        txtprecio.setEnabled(false);
            ...
            for (int i = 0; i < comprar.size(); i++) {
                if (Double.parseDouble((String) SpinPies.getSelectedItem())==8) {
                    if(comprar.get(i).getLargo() == 8){
                        preciocinco = comprar.get(i).getPrecio();
                        txtprecio.setText(preciocinco+"");
                        txtprecio.setEnabled(false);
